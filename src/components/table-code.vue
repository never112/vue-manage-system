    ...
    <div>
        ...
        <div m="4">
          ...
          <el-table :data="props.row.sublist" :border="true">
            ...
            <el-table-column label="未覆盖代码行" prop="misses" />
            <el-table-column label="总代码行" prop="totalLine" />
            <el-table-column label="覆盖率" prop="coverage" />
            <el-table-column label="分支" prop="branch" />
            <el-table-column label="Flag" prop="flag" />
            <el-table-column label="目标" prop="target" />
            <el-table-column label="GAP" prop="gap" />
          </el-table>
        </div>
      </template>
            </el-table-column>
            <el-table-column label="业务线" prop="busUnit" />
            <el-table-column label="测试负责人" prop="testOwner" />
            <el-table-column label="未覆盖代码行" prop="misses" />
            <el-table-column label="总代码行" prop="totalLine" />
            <el-table-column label="已覆盖代码行" prop="coverage" />
            <el-table-column label="分支" prop="branch" />
            <el-table-column label="Flag" prop="flag" />
            <el-table-column label="目标" prop="target" />
            <el-table-column label="当前覆盖率" prop="coverage" />
            <el-table-column label="GAP" prop="gap" />
            <el-table-column label="数据更新时间" prop="updateTime" />
