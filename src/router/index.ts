...
const routes: RouteRecordRaw[] = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: '/dashboard-codecov',
                name: 'dashboard-codecov',
                meta: {
                    title: '覆盖率统计',
                    permiss: '8',
                },
                component: () => import(/* webpackChunkName: "dashboard" */ '../views/dashboard-codecov.vue'),
            },
            {
                path: '/system-user',
                name: 'system-user',
            ...
            
            {
                ...
                component: () => import(/* webpackChunkName: "table-editor" */ '../views/table/covedatatable.vue'),
            },
            ...
            },
            {
                ...
                component: () => import(/* webpackChunkName: "testdemo" */ '../views/chart/testdemo.vue'),
            },
